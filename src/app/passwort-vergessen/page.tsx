...
export default function PasswortVergessenPage() {
  return (
    <AuthShell
      ...
      intro="Geben Sie Ihre E-Mail-Adresse an. Sie erhalten per E-Mail einen Link, mit dem Sie innerhalb von 60 Minuten ein neues Passwort setzen können. Aus Sicherheitsgründen wird der Link nie im Browser angezeigt."
      footer={
